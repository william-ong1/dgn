...
def main() -> None:
    ...
    parser.add_argument(
        "runs_dir",
        type=str,
        help="Parent dir whose DIRECT children are runs (each containing the H5 file).",
    )
    parser.add_argument(
        "--output",
        type=str,
    ...
    parser.add_argument(
        ...
        type=str,
        default="data.h5",
        help="H5 filename inside each run dir (default: data.h5). Use gaussian.h5 for rates.",
    )
    parser.add_argument(
        "--area",
        type=str,
